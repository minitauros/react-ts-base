...
export var FormRowWithInput = function (props) {
    ...
    return (React.createElement("div", { className: classNames.join(' ') },
        ...
        React.createElement("div", { className: "input-container" },
            ...
            React.createElement("input", { required: props.isRequired, autoFocus: props.autofocus, id: htmlId, name: props.name, type: props.type || 'text', value: props.value, onChange: onChange, disabled: props.isDisabled || false })),
